...
final Uri topHeadlineUrl =
    Uri.parse("$baseUrl/top-headlines?country=us&pageSize=25&apiKey=$apiKey");
...
Future<NewsModel> searchArticles(String keyword, [String category = ""]) async {
  Uri searchUrl = Uri.parse(category == ""
      ? "$baseUrl/everything?q=$keyword&Size=50&apiKey=$apiKey"
      : "$baseUrl/top-headlines?q=$keyword&pageSize=100&category=$category&Size=25&apiKey=$apiKey");
  ...
  final f = File('$appDocPath/counter.txt');
